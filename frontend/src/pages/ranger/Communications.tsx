...
export default function Communications() {
  return (
    <div className="p-8 flex flex-col items-center min-h-[70vh] bg-gray-50">
      ...
      <div className="mt-10 text-center text-blue-800 bg-blue-50 border border-blue-200 rounded-lg px-6 py-4 max-w-2xl">
