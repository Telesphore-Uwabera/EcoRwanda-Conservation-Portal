...
export default function PatrolData() {
  ...
  if (error && !loading) return <DashboardLayout><div className="p-8"><Alert variant="destructive"><AlertTitle>Error</AlertTitle><AlertDescription>{error}</AlertDescription></Alert></div></DashboardLayout>;
