      ...
      <Card>
        ...
        <CardContent>
          <div className="flex flex-wrap gap-4 mb-2 text-sm text-gray-600">
            ...
            <Badge variant="outline" className="flex items-center gap-1">
              Access: {publication.accessLevel}
            </Badge>
            <Badge variant="outline" className="flex items-center gap-1">
          ...
          {publication.references && publication.references.length > 0 && (
            <div className="mb-2 text-gray-800 whitespace-pre-line"><b>References:</b> {publication.references.join(', ')}</div>
          )}
          {publication.keywords && publication.keywords.length > 0 && (
            <div className="mb-2 text-gray-800 whitespace-pre-line"><b>Keywords:</b> {publication.keywords.join(', ')}</div>
          )}
          {publication.supplementaryFiles && publication.supplementaryFiles.length > 0 && (
            <div className="mb-2 text-gray-800 whitespace-pre-line"><b>Supplementary Files:</b> {publication.supplementaryFiles.join(', ')}</div>
          )}
          {publication.doi && (
          ...
          {publication.methodology && (
            <div className="mb-2 text-gray-800 whitespace-pre-line"><b>Methodology:</b> {publication.methodology}</div>
          )}
