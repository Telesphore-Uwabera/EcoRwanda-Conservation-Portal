                          ...
                          <TableRow key={applicant._id}>
                            ...
                            <TableCell>
                              <div className="flex gap-2">
                                <Link
                                  to={`/researcher/manage-volunteer-requests/${request._id}/application/${applicant._id}`}
                                  className="inline-block px-3 py-1 text-sm border rounded hover:bg-gray-100 transition-colors"
