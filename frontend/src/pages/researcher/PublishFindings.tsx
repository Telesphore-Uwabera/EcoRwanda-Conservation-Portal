                ...
                {loading ? (
                  ...
                  <ul className="space-y-4">
                    {projects.map((project) => (
                      <Link to={`/researcher/projects/${project._id}`} key={project._id} style={{ textDecoration: 'none' }}>
                        <li className="p-4 border rounded-lg hover:bg-gray-50 transition-colors cursor-pointer">
