                      ...
                      {editingMessageId === msg._id ? (
                        <div className="mt-2">
                          ...
                          <div className="flex gap-2 mt-2">
                            <button onClick={() => handleSaveEdit(msg._id)} className="text-sm bg-blue-500 text-white px-2 py-1 rounded">Save</button>
                        ...
                        <div key={reply._id} className="ml-8 p-3 rounded border bg-gray-50">
                          <div className="flex justify-between items-start">
                            <div>
                              ...
                              <div className="border-l-2 border-blue-200 pl-2 text-xs italic text-gray-500 mb-1">
                              ...
                              {editingMessageId === reply._id ? (
                                <div className="mt-2">
                                  ...
                                  />
                                  <div className="flex gap-2 mt-2">
                                    <button onClick={() => handleSaveEdit(reply._id)} className="text-sm bg-blue-500 text-white px-2 py-1 rounded">Save</button>
                                    <button onClick={handleCancelEdit} className="text-sm bg-gray-300 px-2 py-1 rounded">Cancel</button>
                                  </div>
                                </div>
                              ) : (
