...
import ResearcherApplicationDetails from "./pages/researcher/ResearcherApplicationDetails";
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            />
            <Route
              path="/researcher/volunteer-request/:id"
              element={
                <RoleGuard allowedRoles={["researcher"]}>
                  <DashboardLayout>
                    <VolunteerRequestDetails />
            ...
            />
            <Route
              path="/researcher/manage-volunteer-requests/:requestId/application/:applicationId"
              element={
                <RoleGuard allowedRoles={["researcher"]}>
                  <DashboardLayout>
                    <ResearcherApplicationDetails />
                  </DashboardLayout>
                </RoleGuard>
              }
            />
